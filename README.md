...
[[945] 使数组唯一的最小增量](daily/array/945.使数组唯一的最小增量.py)

[[1013] 将数组分成和相等的三个部分](daily/array/1013.将数组分成和相等的三个部分.py)

[[1380]矩阵中的幸运数](daily/array/5356.矩阵中的幸运数.py)
...
[[1381]设计一个支持增量操作的栈](daily/design/5357.设计一个支持增量操作的栈.py)
...
[[1276]不浪费原料的汉堡制作方案](daily/math/5276.不浪费原料的汉堡制作方案.py)
